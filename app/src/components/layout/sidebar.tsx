    ...
    <div className="w-60 bg-[#0f0f0f] border-r border-[#1a1a1a] flex flex-col h-screen sticky top-0">
      <div className="p-6 flex items-center gap-3">
        ...
        <div className="flex flex-col">
          ...
          <span className="text-[10px] bg-primary/20 text-primary px-1.5 py-0.5 rounded-full w-fit font-medium">BETA</span>
        </div>
      </div>
      ...
      <div className="p-4 space-y-4">
        <div className="bg-secondary/50 rounded-lg p-3 border border-border/50">
          <p className="text-[10px] text-muted-foreground uppercase font-bold tracking-wider mb-1">Usage</p>
          <p className="text-xs font-medium">12 papers processed</p>
